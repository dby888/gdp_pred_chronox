...
for country in countries:
    ...
    years, error_with, error_without, error_organism = [], [], [], []
    ...
    plt.legend()
    plt.savefig(f'figure/{country}_{target_subject}_error_compare.png')
    plt.close()
    ...
    plt.savefig(f'figure/{country}_{target_subject}_rmse_compare.png')
    plt.close()
    ...
    plt.xlabel('Forecast Year')
    plt.ylabel('{target_subject} Value')
    plt.title(f'{target_subject} Prediction Comparison for {country}')
    plt.legend()
    plt.grid(True)
    plt.savefig(f'figure/{country}_{target_subject}_pred_vs_true_compare.png')
    plt.close()
    ...
    excel_path = f'figure/{country}_{target_subject}_results_summary.xlsx'
